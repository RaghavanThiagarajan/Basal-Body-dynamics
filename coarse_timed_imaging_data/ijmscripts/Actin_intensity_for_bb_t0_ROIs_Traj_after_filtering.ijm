...
// The matlab script "t0_time_dist_spatial_plot_Traj_after_filtering.m" gives "TrajecInitPos.csv" where all the initial BB position details are stored. In this script, we use 
// these positions to get the mean intensity values of actin from the Actin movie (Actin_gradient.tif), in the corresponding t0 positions of BB trajectories. Only those trajectories 
